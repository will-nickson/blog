...
export default function ProjectCards() {
    return (
        <div className="flex flex-col gap-8">
            <a
                className="p-4 md:p-8 flex flex-col md:flex-row gap-8 border rounded-md cursor-pointer hover:bg-gray-200 dark:hover:bg-[#313131] shadow-xl dark:shadow-gray-900 hover:dark:shadow-gray-800/90"
                href="https://tripspot.co"
                target="_blank"
            >
                <div className="w-full md:w-1/2">
                    <h3 className="text-lg md:text-xl font-bold">Tripspot</h3>
                    <p className="font-thin mb-4">Founder - 2023</p>
                    <p className="text-sm md:text-base">
                        Tripspot is a site I built for people who love design
                        and travel. It&apos;s a collection of hundreds of the
                        coolest spots in some of the worlds best cities.
                    </p>
                </div>
                <div className="w-full h-full md:w-1/2">
                    <div className="flex items-center justify-center overflow-hidden">
                        ...
                        <NextImage
                            ...
                            src="/images/tripspot-mobile.png"
                            alt="Tripspot"
                            height={300}
                            width={300}
                        />
                        ...
                        <NextImage
                            ...
                            src="/images/tripspot-desktop.png"
                            alt="Tripspot"
                            height={600}
                            width={400}
                        />
